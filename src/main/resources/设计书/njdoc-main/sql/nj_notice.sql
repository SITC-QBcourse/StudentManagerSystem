...
5	本文日本語	text_jp
6	削除フラグ	del_flg
7	登録日時	register_time
8	更新日時	update_time

*/
-- 删除nj_notice表
drop table if exists nj_notice;
-- 创建nj_notice表
create table nj_notice (
    -- notice_id 主键
...
-- 添加数据
insert into nj_notice (title_cn, title_jp,text_cn,text_jp,del_flg,register_time,update_time)
values 
       ("Email 地址验证通知","Emailアドレス認証のお知らせ",
       "To:希望注册账户的人士
...
",
       ...
       ("〈$reserve.companyKj企業〉订单完了通知","〈$reserve.companyKj企業〉注文済のお知らせ", 
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.nameKj网红〉订单完了通知","〈$reserve.nameKjタレント〉注文済のお知らせ", 
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.companyKj企业〉订单承认完了通知","〈$reserve.companyKj企業〉注文承認済のお知らせ", 
       "尊敬的$reserve.companyKj企业：
您好！
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.nameKj网红〉订单承认完了通知","〈$reserve.nameKjタレント〉注文承認済のお知らせ", 
       "尊敬的$reserve.nameKj网红：
您好！
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.nameKj管理者〉网红订单承认完了通知","〈$reserve.nameKj管理者〉タレント注文承認済のお知らせ", 
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.nameKj管理者〉企业订单承认完了通知","〈$reserve.nameKj管理者〉企業注文承認済のお知らせ", 
       "尊敬的$reserve.nameKj管理者：
您好！
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.companyKj企业〉订单公开完了通知","〈$reserve.companyKj企業〉注文公開済のお知らせ", 
       "尊敬的$reserve.companyKj企业：
您好！
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.nameKj网红〉订单公开完了通知","〈$reserve.nameKjタレント〉注文公開済のお知らせ", 
       "尊敬的$reserve.nameKj网红：
您好！
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.nameKj管理者〉企业订单公开完了通知","〈$reserve.nameKj管理者〉企業注文公開済のお知らせ", 
       "尊敬的$reserve.nameKj管理者：
您好！
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.nameKj管理者〉网红订单公开完了通知","〈$reserve.nameKj管理者〉タレント注文公開済のお知らせ", 
       "尊敬的$reserve.nameKj管理者：
您好！
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.companyKj企业〉订单否认完了通知","〈$reserve.companyKj企業〉注文否認済のお知らせ", 
       "尊敬的$reserve.companyKj企业：
您好！
...
",
       "0","2023/07/07","2023/07/07"),
       ("〈$reserve.nameKj网红〉订单否认完了通知","〈$reserve.nameKjタレント〉注文否認済のお知らせ", 
       "尊敬的$reserve.nameKj网红：
您好！
