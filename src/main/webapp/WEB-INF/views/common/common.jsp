<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="${pageContext.request.contextPath}/favicon_v2.ico">
        <script type="text/javascript" src="${pageContext.request.contextPath}/h-ui.admin/lib/jquery/1.9.1/jquery.js"></script>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/h-ui.admin/static/h-ui/css/H-ui.css">
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/h-ui.admin/static/h-ui.admin/css/style.css">
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/h-ui.admin/lib/Hui-iconfont/1.0.8/iconfont.min.css">
    </head>
    <body>
    </body>
    </html>