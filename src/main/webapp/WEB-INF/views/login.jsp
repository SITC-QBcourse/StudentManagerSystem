			...
			<%@ include file="variable/login_variable.jsp" %>
				...
				<body>
					<div class="header" style="padding:0">
						<h2 style="color:white;width:400px;height:60px;line-height: 60px;margin-left: 30px;padding: 0;">
					...
					<div class="loginWraper">
						<div id="loginform" class="loginBox">
							<form:form action="${pageContext.request.contextPath}/ok" method="post"
								...
								<div class="row cl">
									...
									<div class="formControls col-8">
										...
										placeholder="${vcode}" />
										<img title="${vcodeChange}" id="vocdeImg"
										src="${pageContext.request.contextPath}/getGeneratorCoode" />
									</div>
								</div>
								<div class="row cl">
									<div class="formControls col-8 col-offset-3">
										<input type="submit" style="width:150px;" class="btn btn-success radius size-L"
											value="${btnSubmit}">
